...
public:
     ...
     * @note Direction does not need to be normalized, but some algorithms may assume it.
     ***********************/
     ...
     * @note If D is not normalized, t represents scaled units, not exact distance.
     ***********************/
